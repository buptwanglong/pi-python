"""
Shared pytest fixtures for pi-coding-agent tests.
"""
...
from pi_ai.types import AssistantMessage, Context, TextContent, ToolCall
...
def mock_stream_with_tool_call(monkeypatch):
    """
    Mock the pi_ai.stream function to return a tool call response.
    """
    from pi_ai import api
