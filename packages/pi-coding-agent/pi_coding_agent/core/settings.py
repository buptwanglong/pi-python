...
class SettingsManager:
    ...
    Settings are stored in JSON format at ~/.pi-coding-agent/settings.json
    """
    ...
    def __init__(self, config_dir: Optional[Path] = None):
        ...
        Args:
            config_dir: Configuration directory (default: ~/.pi-coding-agent)
        """
        if config_dir is None:
            config_dir = Path.home() / ".pi-coding-agent"
